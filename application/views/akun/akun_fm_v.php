<div class="modal-dialog modal-default" style="z-index:20000;">
    <div class="modal-content">
        <form id="form-akunpeg" action="javascript:ubah();">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="usr" id="usr_" class="form-control" placeholder="Username" readonly>
                </div>
                <div class="form-group">
                    <label>Level User</label>
                    <input type="text" name="lev" id="lev_" class="form-control" placeholder="Level User" readonly>
                </div>
                <div class="form-group">
