...
<div id="respon1"></div>
<div class="row">
    <div id="dt_jabatan" class="col-md-8"><?php $this->load->view('jabatan/jabatan_dt_v') ?></div>
    <div id="fm_jabatan" class="col-md-4"><?php $this->load->view('jabatan/jabatan_fm_v') ?></div>
</div>
...
function inc() {
    ...
    url = "<?php echo site_url('Admin/jabatan_save')?>";
...
function load_jabatan(kd,e){
    ...
    $.ajax({
        ...
        url: "<?php echo base_url(); ?>Admin/load_jabatan",
