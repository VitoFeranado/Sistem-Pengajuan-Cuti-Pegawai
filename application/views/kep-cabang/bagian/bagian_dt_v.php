      ...
      <table class="table table-bordered table-striped" id="tb_bagian">
        ...
        ?>
            <tr>
                ...
                <td>
                    <a title="Edit" href="javascript:;" onclick="edit('<?php echo $r1->id_bagian ?>','<?php echo $r1->bagian ?>')" class="btn btn-default btn-xs xtooltip"><i class="fa fa-edit"></i> Edit</a>
                </td>
            </tr>
        <?php
            }
...
function edit(id,nm){
  $("#id_bagian_").val(id);
  $("#nm_bagian_").val(nm);
  document.getElementById("nm_bagian_").readOnly = false;
