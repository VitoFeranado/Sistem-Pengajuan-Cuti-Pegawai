...
<div id="respon1"></div>
<div class="row">
    <div id="dt_bagian" class="col-md-8"><?php $this->load->view('kep-cabang/bagian/bagian_dt_v') ?></div>
    <div id="fm_bagian" class="col-md-4"><?php $this->load->view('kep-cabang/bagian/bagian_fm_v') ?></div>
</div>
...
function bersih()
{
    ...
    document.getElementById("nm_bagian_").readOnly = true;
...
function inc() {
    ...
    url = "<?php echo site_url('Pimpinan/bagian_save')?>";
...
function load_bagian(kd,e){
    ...
    $.ajax({
        ...
        url: "<?php echo base_url(); ?>Pimpinan/load_bagian",
