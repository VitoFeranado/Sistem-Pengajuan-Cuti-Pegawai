      ...
      <table class="table table-bordered table-striped" id="tb_jabatan">
        ...
        ?>
            <tr>
                ...
                <td>
                    <a title="Edit" href="javascript:;" onclick="edit('<?php echo $r1->id_jabatan ?>','<?php echo $r1->jabatan ?>')" class="btn btn-default btn-xs xtooltip"><i class="fa fa-edit"></i> Edit</a>
                </td>
            </tr>
        <?php
            }
...
function edit(id,nm){
  $("#id_jabatan_").val(id);
  $("#nm_jabatan_").val(nm);
  document.getElementById("nm_jabatan_").readOnly = false;
