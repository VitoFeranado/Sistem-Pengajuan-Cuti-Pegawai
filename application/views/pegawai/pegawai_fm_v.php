<div class="box box-info">
  ...
  <form id="form-jcuti" action="javascript:inc();">
    <div class="form-group">
      ...
      <input type="text" name="nm_jeniscuti" id="nm_jeniscuti_" class="form-control" placeholder="Jenis Cuti" required>
      <input type="hidden" id="id_jeniscuti_" name="id_jeniscuti">
      <input type="hidden" id="action" name="action">
    </div>
    <div class="form-group">
      <label>Banyak nya <i>(dalam hari)</i> :</label>
      <input type="number" name="jml" id="jml_" class="form-control" placeholder="Banyak nya" required>
    </div>
