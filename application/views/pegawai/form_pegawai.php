<div class="modal-dialog modal-default" style="z-index:20000;">
    <div class="modal-content">
        <form id="form-pegawai" action="javascript:simpan();">
            ...
            <?php
                $query = $this->db->query("SELECT RIGHT(idpeg,3) as kode FROM tb_pegawai ORDER BY idpeg DESC LIMIT 1");
                if($query->num_rows() <> 0){
                    $data = $query->row();
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="id_pegawai" class="form-control" placeholder="ID Pegawai" value="<?php echo $hsl ?>" required readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>No. Telp</label>
                    <input onkeypress="return check_int(event)" type="text" name="telp" class="form-control" placeholder="No Telp" required maxlength="15">
                </div>
                <div class="form-group">
                    <label>Bagian</label>
                ...
                <div class="form-group">
                    <label>NPP</label>
                    <input type="text" name="npp" class="form-control" placeholder="NPP" maxlength="6">
                </div>
                <div class="form-group">
